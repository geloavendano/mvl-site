-- Lets waiver Instagram handles stay free-form and optional.
--
-- Apply with:
--   supabase db query --linked --file supabase/migrations/20260802000700_relax_instagram_handle_validation.sql
