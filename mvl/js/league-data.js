window.MVL_DATA = {
  ...
  teams: [
    { id: 'metarice-x', name: 'Metarice X', code: 'MTX', tag: 'Mint Division', grad: ['#3FE39A', '#0E7A4C'], bg: '/mvl/assets/teams/background/mint-green.webp', photo: '/mvl/assets/player-metarice-x-soco.webp', pos: '76% 24%', roster: '/mvl/assets/teams/roster/metarice-x.webp' },
    { id: 'metarice-y', name: 'Metarice Y', code: 'MTY', tag: 'Violet Division', grad: ['#7C3BFF', '#2E00A8'], bg: '/mvl/assets/teams/background/violet.webp', photo: '/mvl/assets/player-metarice-y-bry.webp', pos: '76% 20%', roster: '/mvl/assets/teams/roster/metarice-y.webp' },
    { id: 'thurstrap', name: 'Thurstrap', code: 'THT', tag: 'Aqua Division', grad: ['#10E0D4', '#078D96'], bg: '/mvl/assets/teams/background/blue.webp', photo: '/mvl/assets/player-thurstrap-chad.webp', pos: '72% 22%', roster: '/mvl/assets/teams/roster/thurstrap.webp' },
    { id: 'gizmo', name: 'Gizmo Spikers', code: 'GZM', tag: 'Pink Division', grad: ['#FF3FB4', '#D50083'], bg: '/mvl/assets/teams/background/pink.webp', photo: '/mvl/assets/player-gizmo-spikers-chris.webp', pos: '78% 25%', roster: '/mvl/assets/teams/roster/gizmo.webp' },
    { id: 'gremlins', name: 'Gremlins', code: 'GML', tag: 'Forest Division', grad: ['#3D9E2A', '#0D4E14'], bg: '/mvl/assets/teams/background/forest-green.webp', photo: '/mvl/assets/player-gremlins-nash.webp', pos: '20% 72%', roster: '/mvl/assets/teams/roster/gremlins.webp' },
    { id: 'ssvc', name: 'SSVC', code: 'SVC', tag: 'Yellow Division', grad: ['#FFE44D', '#D6A900'], bg: '/mvl/assets/teams/background/yellow.webp', photo: '/mvl/assets/player-ssvc-anthony.webp', pos: '20% 74%', roster: '/mvl/assets/teams/roster/ssvc.webp' },
    { id: 's24', name: 'S24', code: 'S24', tag: 'Red Division', grad: ['#F51642', '#B90025'], bg: '/mvl/assets/teams/background/red.webp', photo: '/mvl/assets/player-s24-onjon.webp', pos: '78% 24%', roster: '/mvl/assets/teams/roster/s24.webp' },
    { id: 'secret', name: 'Secret', code: 'SEC', tag: 'Orange Division', grad: ['#FF9A05', '#FF5A00'], bg: '/mvl/assets/teams/background/orange.webp', photo: '/mvl/assets/player-secret-pao.webp', pos: '22% 72%', roster: '/mvl/assets/teams/roster/secret.webp' },
  ],
  ...
  sponsors: [
    ...
    { name: "Garnier", tier: 'Co-Presenters', order: 4, logoBg: 'mint', logo: '/mvl/assets/Sponsor Logos/Co-Presenters/garnier.PNG' },
    { name: "Listerine", tier: 'Co-Presenters', order: 5, logo: '/mvl/assets/Sponsor Logos/Co-Presenters/Listerine.png' },
    { name: "OFBANK", tier: 'Co-Presenters', order: 6, logo: '/mvl/assets/Sponsor Logos/Co-Presenters/OFBANK LOGO.jpg' },
    // dark grey wordmark on transparent — invisible on the navy strip without a chip
    { name: "Strepsils", tier: 'Co-Presenters', order: 7, logoBg: 'mint', logo: '/mvl/assets/Sponsor Logos/Co-Presenters/Strepsils.png' },
    { name: "The Resthouse Laiya", tier: 'Co-Presenters', order: 8, logo: '/mvl/assets/Sponsor Logos/Co-Presenters/The Resthouse Laiya.png' },
