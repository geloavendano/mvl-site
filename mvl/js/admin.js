...
livestreamForm.addEventListener('submit', async (e) => {
  ...
  try {
    const streams = [
      { court: 'Left Court', is_live: f.court1Live.checked, youtube_url: f.court1Url.value.trim(), youtube_id: youtubeId(f.court1Url.value) || '' },
      { court: 'Right Court', is_live: f.court2Live.checked, youtube_url: f.court2Url.value.trim(), youtube_id: youtubeId(f.court2Url.value) || '' },
    ];
